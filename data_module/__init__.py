...
DATASETS = {
    ...
    'Intersectional Bias 🧪': {
        ...
        'year': '2022',
        'original_n': 10000,
        'target_label': 'Diagnóstico clínico (esquizofrenia ou depressão)',
        'favorable_label': '0 — Saudável (sem diagnóstico de doença mental)',
        'description': "Partição de <b>treino</b> do benchmark sintético FAccT 2022 (10.000 instâncias). Desenvolvido para auditar classificadores de saúde mental com disparidades interseccionais ocultas entre raça e sexo."
    },
    'SIH (DATASUS) 🇧🇷': {
